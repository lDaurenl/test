...
class Job extends Model {
  ...
  /**
   *
   * @param jobs - массив с подготовленной информацией для создания работы
   * @param client- инстанс модели Клиента,куда привязана работа
  ...
  /**
   *
   * @param jobObj - обьект с информацией о работе
   * @param client - инстанс модели клиента
  ...
  /**
   *
   * @param jobs - массив обьектов с  информацией для создания работы
   * @param client - инстанс модели клиента,куда будут привязаны работы
